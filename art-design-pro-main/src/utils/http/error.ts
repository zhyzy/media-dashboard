 ...
 * @returns 错误消息
 */
const getErrorMessage = (status: number, backendMsg?: string): string => {
...
export function handleError(error: AxiosError<ErrorResponse>): never {
  ...
  if (responseData) {
    if (typeof responseData.message === 'string') {
      ...
      backendMsg = responseData.message.join('; ')
  ...
  const message = statusCode
    ? getErrorMessage(statusCode, backendMsg)
    : backendMsg || error.message || $t('httpMsg.requestFailed')
